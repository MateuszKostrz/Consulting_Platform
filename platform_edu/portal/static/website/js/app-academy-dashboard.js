...
document.addEventListener('DOMContentLoaded', function (e) {
  ...
  const leadsReportChartEl = document.querySelector('#leadsReportChart'),
    leadsReportChartConfig = {
      ...
      labels: ['Poland', 'Belarus', 'China', 'Belgium', 'Germany', 'Other'],
      series: [12456, 4231, 2987, 1876, 1123, 516],
      colors: [
  ...
  const horizontalBarChartEl = document.querySelector('#horizontalBarChart'),
    horizontalBarChartConfig = {
      ...
      labels: ['Math AI SL', 'Math AA SL', 'Math AI HL', 'Math AA HL', 'CS HL', 'Bio HL'],
      series: [
        {
          data: [421, 387, 375, 360, 211, 198]
        }
      ],
