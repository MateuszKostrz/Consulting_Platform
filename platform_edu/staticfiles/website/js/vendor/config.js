...
if (typeof TemplateCustomizer !== 'undefined') {
  window.templateCustomizer = new TemplateCustomizer({
    ...
    // Modified controls to only include those affecting sidebar and top bar
    controls: [
      'layoutCollapsed',   // Controls sidebar collapse state
      'layoutNavbarOptions', // Controls navbar options
      'semiDark',           // Controls dark menu
      'theme'               // Controls overall theme (affects sidebar/navbar)
    ]
  });
}
